        ...
        <section class="content-header col-md-12" style="margin:10px; display:inline">
            ...
            <div class="heder-tab" style=" margin-left:20px;  padding:10px;
                ...
                <ol id="menu" class="breadcrumb">
                    ...
                    <li><a href="">Spetifications / </a></li>
                    <li class="active">List</li>

                </ol>
                <div style="float: right;margin-top:-32px"><a href="{{ route('spetification.create') }}"><button
                            class="btn btn-success">Thêm thông số kĩ thuật</button></a></div>
            </div>
