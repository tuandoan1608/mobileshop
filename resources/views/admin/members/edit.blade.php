...
@section('content')
    <div class="content-wrapper">
        ...
        <form accept-charset="utf-8" action="/admin/user/{{ $user->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <!-- Main content -->
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="text" name="firstname" class="form-control" placeholder="" value="{{ $user->firstname }}" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <label for="disabledTextInput">Số điện thoại
                                                            <span style="color: red;font-size:20px">*</span></label>
                                                        <input type="number" name="phone" class="form-control" placeholder="" value="{{ $user->phone }}" required>
                                                        ...
                                                        <select class="js-example-basic-multiple form-control" name="role[]"
                                                            ...
                                                            @foreach ($role as $item)
                                                                <option {{ $userrole->contains('id',$item->id)?'selected':'' }} value="{{ $item->id }}">{{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
